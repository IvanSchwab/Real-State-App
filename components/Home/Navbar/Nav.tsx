    ...
    return (
        <div className={`fixed h-[10vh] z-[100] w-full transition-all duration-500 ease-in-out ${navBg ? 'bg-custom-green' : 'bg-transparent'}`}>
            ...
            <div className="flex items-center h-[80%] mt-2 justify-between w-[95%] sm:w-[90%] md:w-[85%] xl:w-[80%] mx-auto">
                {/* Logo */}
                <div className="bg-custom-green  p-2 rounded-md max-w-xs shadow-md mx-auto sm:ml-[-50px] md:ml-[-20px]">
                    <img
                        src="/images/logo-background.png"
                        alt="Logo"
                        className="object-cover w-full h-[54px] rounded-md"
                    />
                </div>

                {/* Sección de enlaces de navegación */}
                <div className="lg:flex items-center space-x-14 text-white hidden flex-grow justify-center transform xl:-translate-x-[105px] md:space-x-8">
