...
const PropertyList: React.FC = () => {
  ...
  return (
    <>
      ...
      <div>
        <div className="bg-[#f8fcf3] pt-44 px-4 w-full">
          <br />
          <div className="absolute top-4 right-4 z-50">
            ...
            <button
              ...
              className="fixed top-4 right-4 md:block px-4 py-2 bg-custom-green bg-opacity-75 text-white font-medium rounded-lg shadow-md hover:bg-custom-green hover:bg-opacity-90 transition duration-300 ease-in-out"
              data-aos="fade-in"
            >
              Volver al Inicio
            </button>
